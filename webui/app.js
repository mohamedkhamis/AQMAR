  ...
  return {
    ...
    get aboutBlocks() {
      return [
        ...
        { ar: ['٣. التحرير','واجهة الإدارة تتيح تصحيحَ كلّ حقلٍ. التعديلاتُ تُحفظ في overrides.json وتنجو من إعادة التشغيل.'], en: ['3. Editing','The admin UI lets you correct any field. Edits live in overrides.json and survive re-runs.'] },
